...
O atalho global do mouse pode ser configurado na janela com `Configurar atalho de gravação` sob sessão X11 com `DISPLAY`; em Wayland ou sem atalho configurado, a tecla `Space` na janela e o botão `Gravar` continuam operando normalmente.
