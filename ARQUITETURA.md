...
- `falafacil.__version__` é a fonte única de versão do pacote Python (`0.2.2`), consumida dinamicamente pelo `pyproject.toml` via `[tool.setuptools.dynamic]`, pelo `QApplication` em runtime e pelo modo `--update-probe` do bundle.
